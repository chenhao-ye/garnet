...
namespace Garnet.cluster
{
    internal sealed unsafe partial class ClusterSession : IClusterSession
    {
        ...
        /// <summary>
        /// Implements CLUSTER SLOG_KEY_TIME command.
        /// If node is replica, it returns key sequence number otherwise the latest sequence number as generated by the sequence number generator.
