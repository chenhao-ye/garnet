...
namespace Garnet.server
{
    ...
    internal sealed unsafe partial class RespServerSession : ServerSessionBase
    {
            ...
            : base(networkSender)
        {
            ...
            if (storeWrapper.serverOptions.EnableCluster && storeWrapper.serverOptions.EnableAOF && storeWrapper.serverOptions.MultiLogEnabled && !storeWrapper.serverOptions.DisablePrefixConsistency && storeWrapper.appendOnlyFile != null)
