...
namespace Garnet.server
{
    ...
    public class ReadConsistencyManager(long currentVersion, GarnetAppendOnlyFile appendOnlyFile, GarnetServerOptions serverOptions)
    {
        ...
        /// </summary>
        public readonly ReplayAlignBarrier replayBarrier = new(serverOptions.AofVirtualSublogCount);
        ...
        void VerifyKeyFreshness(long hash, ref ReplicaReadSessionContext replicaReadSessionContext, CancellationToken ct)
        {
            ...
            {
                RefreshAndMaybeWait(virtualSublogIdx, hash, ref replicaReadSessionContext, ct);
            }
        ...
        void RefreshAndMaybeWait(short virtualSublogIdx, long hash, ref ReplicaReadSessionContext replicaReadSessionContext, CancellationToken ct)
        {
            ...
            if (maxSessionSeqNum >= publishedMax)
            {
                ...
                BoundReplayDrift();
                vsrs[virtualSublogIdx].WaitForSequenceNumber(hash, maxSessionSeqNum, ct, replicaSyncTimeoutMs);
            }
        }
