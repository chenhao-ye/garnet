...
namespace Garnet.server
{
    ...
    public sealed class AofBackpressure : IDisposable
    {
        ...
        public AofBackpressure(GarnetServerOptions serverOptions, ILogger logger = null)
        {
            ...
            logger?.LogInformation("AofBackpressure enabled: stall lag {stallLagBytes} bytes, resume lag {resumeLagBytes} bytes, summed across sublogs", stallLagBytes, resumeLagBytes);
        }
